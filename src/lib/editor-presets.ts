...
export const EDITOR_PRESETS: EditorPreset[] = [
  ...
  },
  {
    id: 'skin-realism',
    title: 'Melhorar pele',
    promptBase: 'CRÍTICO: Preserve 100% a identidade da pessoa (formato do rosto, traços faciais, expressão, maquiagem se houver). Melhore APENAS a textura e qualidade da pele mantendo todas as características originais intactas. Adicione textura de pele humana autêntica: poros visíveis mas sutis, micro-variações de tom suaves. Se houver maquiagem (batom, sombra, blush, etc), preserve EXATAMENTE como está. Corrija o brilho artificial dos olhos mantendo OBRIGATORIAMENTE a cor natural original dos olhos, adicionando apenas reflexos naturais e pequenas imperfeições realistas (veias leves, úmidade natural). Naturalize cabelos: adicione fios soltos, baby hairs, textura individual de cada fio, brilho natural não uniforme. Ajuste textura dos lábios mas mantenha cor e formato originais. Remova apenas o aspecto "plástico" ou "perfeito demais" da pele, sem alterar estrutura facial. NÃO ALTERE: formato do rosto, traços faciais, maquiagem, expressão, identidade da pessoa, tom de pele original, COR DOS OLHOS. NÃO ADICIONE: sardas, manchas, vermelhidão nas maçãs do rosto, ou qualquer característica que não existia na foto original. Resultado: mesma pessoa com pele naturalizada e textura humana realista.',
  ...
  },
  {
    ...
    subPresets: [
      ...
      },
      {
        ...
        promptBase: 'Crie uma fotografia de moda/produto vestível apresentando a peça em modelo humano ou manequim profissional. Use a imagem anexada como referência da roupa/acessório, mantendo 100% de fidelidade visual (corte, tecido, cor, detalhes, caimento). MODELO: se a peça for roupa, apresente em modelo humano realista (corpo proporcional, pose natural e elegante) OU manequim de loja profissional. Se for acessório vestível (relógio, bolsa, sapato), mostre em uso ou em modelo apropriado. FUNDO: estúdio fotográfico profissional com fundo infinito em gradiente suave (cinza médio degradê para cinza escuro, ou tons neutros como bege/marrom/cinza), sem elementos distrativos, transição suave entre chão e parede criando efeito de profundidade e sofisticação. ILUMINAÇÃO: estúdio de moda profissional com iluminação cinematográfica, luz principal suave e difusa, luz de preenchimento sutil, backlight para separar modelo do fundo, sombras suaves no chão criando profundidade, destaque na textura do tecido e detalhes da peça. COMPOSIÇÃO: corpo inteiro ou 3/4, foco total na roupa/acessório, modelo serve apenas para mostrar caimento e escala, pose elegante mas não exagerada, posicionamento centralizado ou seguindo regra dos terços. CAIMENTO: tecido com dobras e vincos naturais, física realista do material, ajuste apropriado ao corpo. ATMOSFERA: profissional, elegante, comercial mas sofisticado, estilo catálogo de moda premium. RESULTADO: foto comercial de moda/produto de alta qualidade, pronta para e-commerce de roupas e acessórios ou lookbook.',
