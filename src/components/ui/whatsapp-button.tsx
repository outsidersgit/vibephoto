...
// WhatsApp Official Icon - White version for colored backgrounds
...
export function WhatsAppButton({
  ...
  const content = (
    <>
      <WhatsAppIconOfficial size={iconOnly && size === 'icon' ? 32 : 22} />
  ...
  return (
    ...
    >
      <WhatsAppButton
        ...
        iconOnly
        showTooltip
        className="bg-[#25D366] hover:bg-[#20BA5A] hover:scale-110 transition-all text-white h-14 w-14 rounded-full shadow-lg hover:shadow-2xl border-0"
      />
    </div>
  )
}
