...
interhalf_body ModelCreationStep2HalfBodyProps {
  modelData: {
    name: string
...
export function ModelCreationStep2HalfBody({ modelData, setModelData, modelCostInfo }: ModelCreationStep2HalfBodyProps) {
