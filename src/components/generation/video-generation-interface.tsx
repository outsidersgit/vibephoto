          ...
          {previewMedia?.type === 'video' && (
            <>
              <button
                ...
                className="absolute right-16 top-3 inline-flex items-center gap-1 rounded-full border border-transparent bg-white/90 px-3 py-1 text-xs font-medium text-gray-900 shadow transition-all duration-200 hover:bg-white hover:border-[#3b82f6] focus:outline-none focus:border-[#3b82f6] focus:ring-2 focus:ring-[#3b82f6]/60"
              >
