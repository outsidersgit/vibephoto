...
export default function CreateModelPage() {
  ...
  const steps = [
    ...
    },
    {
      ...
      description: '2-4 fotos de meio corpo',
      completed: modelData.halfBodyPhotos.length >= 2
    },
    {
      number: 3,
      title: 'Fotos de Corpo Inteiro',
      description: '2-3 fotos de corpo inteiro',
      completed: modelData.fullBodyPhotos.length >= 2
    },
    {
      number: 4,
  ...
  const canProceedToNext = () => {
    switch (currentStep) {
      case 1:
        return modelData.name && modelData.class && modelData.facePhotos.length >= 4 && !isAnalyzingStep1
      case 2:
        return modelData.halfBodyPhotos.length >= 2
      case 3:
        return modelData.fullBodyPhotos.length >= 2
      case 4:
        return true
      default:
        return false
