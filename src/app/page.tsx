  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      {!session ? (
        ...
        <section className="lg:hidden bg-gradient-to-b from-black/90 to-gray-900 py-8 px-4">
          <div className="max-w-sm mx-auto space-y-4">
            {/* Lead Capture Card */}
            <div className="bg-black/80 backdrop-blur-md rounded-xl shadow-2xl p-5 border border-white/30">
              <form 
                onSubmit={async (e) => {
                  e.preventDefault()
                  const form = e.target as HTMLFormElement
