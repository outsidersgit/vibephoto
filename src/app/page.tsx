        ...
        <section className="relative h-screen w-full overflow-hidden" style={{fontFamily: '"SF Pro Display", -apple-system, BlinkMacSystemFont, system-ui, sans-serif'}}>
          ...
          <div className="relative z-10 h-full flex items-center justify-between px-6 max-w-7xl mx-auto">
            ...
            <div className="flex-1 max-w-2xl">
              ...
              {/* Mobile Lead Capture Card */}
              <div className="lg:hidden mb-6 px-4">
                <div className="max-w-sm mx-auto bg-black/80 backdrop-blur-md rounded-xl shadow-2xl p-5 border border-white/30">
                  <form 
                    onSubmit={async (e) => {
                      e.preventDefault()
              ...
              <div className="flex px-4 lg:px-0">
                <Button
                  variant="outline"
                  size="lg"
                  className="border-2 border-white text-white bg-transparent hover:bg-white hover:text-black px-6 sm:px-8 py-3 text-base font-medium rounded-lg backdrop-blur-sm hover:shadow-lg transform hover:scale-105 transition-all duration-200 w-full sm:w-auto"
                  onClick={() => {
